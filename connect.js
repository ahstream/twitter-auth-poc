...
async function main() {
  ...
  function handleTwitterCallback(req, res) {
    ...
    console.log('/twitter/callback 2', { oauthRequestToken, oauthRequestTokenSecret, oauthVerifier });

    return getOAuthAccessTokenWith({ oauthRequestToken, oauthRequestTokenSecret, oauthVerifier }).then(async ({ oauthAccessToken, oauthAccessTokenSecret, results }) => {
